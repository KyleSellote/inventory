 ...
 * @author SCC-COLLEGE
 */
public class user1dashboard extends javax.swing.JFrame {

    /**
     * Creates new form admindashboard
     */
    public user1dashboard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel7);
        jPanel7.setBounds(0, 70, 100, 260);
        ...
        jPanel1.add(jPanel8);
        jPanel8.setBounds(100, 60, 500, 270);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(user1dashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new user1dashboard().setVisible(true);
            }
        });
    }
